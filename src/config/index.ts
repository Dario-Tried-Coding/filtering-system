...
export const CLOTHING_TYPES = ['SHIRT', 'JEANS'] as const
export const SORTING_OPTIONS = ['PRICE_ASC', 'PRICE_DESC'] as const

export type COLOR = (typeof COLORS)[number]
export type SIZE = (typeof SIZES)[number]
export type PRICE = (typeof PRICES)[number]
export type CLOTHING_TYPE = (typeof CLOTHING_TYPES)[number]
export type SORTING_OPTION = (typeof SORTING_OPTIONS)[number]